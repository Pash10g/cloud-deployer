...
# Install mongodb backend for the mms server
...
case node['platform_family']
  when 'rhel', 'fedora'
    mms_server_source = "https://downloads.mongodb.com/on-prem-mms/rpm/mongodb-mms-#{node['mongodb3']['config']['mms_server']['version']}.x86_64.rpm?_ga=1.13465655.1636956437.1454340685"
    mms_server_file = "/root/mongodb-mms_#{node['mongodb3']['config']['mms_server']['version']}_x86_64.rpm"
  when 'debian'
    mms_server_source = "https://downloads.mongodb.com/on-prem-mms/deb/mongodb-mms_#{node['mongodb3']['config']['mms_server']['version']}_x86_64.deb?_ga=1.189190187.1636956437.1454340685"
    mms_server_file = "/root/mongodb-mms_#{node['mongodb3']['config']['mms_server']['version']}_x86_64.deb"
end
